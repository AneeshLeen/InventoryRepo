...
{
    public partial class FNewMainForm3 : Form
    {
        string sUser = "";
        ...
        private void btnCreditSalesNumber_Click(object sender, EventArgs e)
        {
        ...
        private void btnProductsNumber_Click(object sender, EventArgs e)
        {
            fProducts oFPro = new fProducts();
            oFPro.ShowDialog();
        }

        private void btnCashCollectionsNumber_Click(object sender, EventArgs e)
        {
            fCashCollections oFCashColls = new fCashCollections();
            oFCashColls.ShowDialog();
        }

        private void btnCashDeliverysNumber_Click(object sender, EventArgs e)
        {
            fCashDeliverys oFCashColls = new fCashDeliverys();
            oFCashColls.ShowDialog();
        }
        ...
        private void btnCreateCrediSale_Click(object sender, EventArgs e)
        {
            FCreditSale ofrm = new FCreditSale();
            CreditSale oCreditSale = new CreditSale();
            ofrm.ShowDlg(oCreditSale, true, "New");
        }
        ...
        private void btnCreateCashCollection_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnCreateCashDelivery_Click(object sender, EventArgs e)
        {
            try
            {
                fCashDelivery frm = new fCashDelivery();
               // frm.ItemChanged = RefreshList;
                frm.ShowDlg(new CashCollection(), false);
