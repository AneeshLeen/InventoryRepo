...
{
    public partial class fExpenditureAndIncome : Form
    {
        ...
        private void RefreshObject()
        {
            ...
            _Expenditure.EntryDate = dtpExpenseDate.Value != DateTime.MinValue ? (DateTime)dtpExpenseDate.Value : DateTime.Now; 
        ...
        private bool IsValid()
        {
            ...
            {
                MessageBox.Show("Please Enter Expense/Income Purpose.", "Expense and Income", MessageBoxButtons.OK, MessageBoxIcon.Information);
