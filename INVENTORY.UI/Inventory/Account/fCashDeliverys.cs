...
namespace INVENTORY.UI
{
    ...
    public partial class fCashDeliverys: Form
    {
        DEWSRMEntities db = null;
        public fCashDeliverys()
        {
        ...
        private void RefreshList()
        {
            try
            {
                using (DEWSRMEntities db = new DEWSRMEntities())
                {
                    ...
                    var _CashCollections = db.CashCollections.Where( t=>t.TransactionType==1).OrderByDescending(c => c.EntryDate).ToList();
                    ...
                    if (_CashCollections != null)
                    {
                        ...
                        foreach (CashCollection oCashColl in _CashCollections)
                        {
                            ...
                            {
                                dr["name"] = oCashColl.Supplier.OwnerName;
